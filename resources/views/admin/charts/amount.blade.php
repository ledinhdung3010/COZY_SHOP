...
@section('breadcrumb-item-1','By product amount')
@section('breadcrumb-item-2','AMOUNT')
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        <form action="{{route('admin.charts.amount.get')}}" class="border p-3" method="post">
            @csrf
            <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        var errorMessage = document.getElementById('errorMessage');
            ...
            $.ajax({
                url: "{{ route('admin.charts.amount.get') }}",
                type: "POST",
